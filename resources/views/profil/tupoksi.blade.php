...
@section('title', 'Tugas Pokok dan Fungsi - Dinas Pendidikan Kabupaten Sumenep')
@section('content')
    ...
    <div class="tupoksi-grid">
      <div class="tupoksi-card tupoksi-card-dark">
        ...
        <p class="tupoksi-desc">
          Berdasarkan Peraturan Bupati Kabupaten Sumenep tentang Kedudukan, Susunan Organisasi, Tugas Dan Fungsi, Serta Tata Kerja Dinas Pendidikan, Dinas Pendidikan Kabupaten Sumenep mempunyai tugas dan kewajiban membantu bupati melaksanakan urusan pemerintahan yang menjadi kewenangan daerah bidang pendidikan. Dalam menyelenggarakan tugas dan kewajiban tersebut Dinas Pendidikan Kabupaten Sumenep mempunyai fungsi:
        </p>
      ...
      <div class="tupoksi-card tupoksi-card-light">
        <div class="tupoksi-image">
          <img src="{{ asset('user-assets/image/bg2.png') }}" alt="Gedung Dinas Pendidikan Kabupaten Sumenep">
        </div>
        <div class="tupoksi-content">
          <h3 class="tupoksi-title">Permasalahan Strategis yang Diidentifikasi</h3>
          <ul class="tupoksi-list">
            <li><i class="bi bi-check-circle"></i> Masih rendahnya capaian Indeks Pendidikan Kabupaten Sumenep dibandingkan daerah lain.</li>
