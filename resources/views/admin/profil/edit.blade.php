...
<style>
    ...
    .profil-tabs .nav-link { color:#7f6267 !important; font-weight:700; font-size:.85rem; border:none; border-bottom:3px solid transparent; padding:12px 4px; margin-right:26px; }
    ...
    .form-group label { font-weight:700; font-size:.82rem; color:#0B1F3A; }
    .form-hint { font-size:.75rem; color:#9a8a8e; margin-top:4px; }
    ...
    .sosmed-input-group.tiktok .input-group-text { color:#111827; }
    .preview-card { border:1px solid #eee0e3; border-radius:.5rem; padding:20px; background:#fff5f7; }
    .preview-card h6 { font-weight:800; color:#162F55; font-size:.78rem; text-transform:uppercase; letter-spacing:.5px; }
...
@section('content')
    ...
    <form id="formProfil" action="{{ route('admin.profil.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="card shadow mb-4">
                    <div class="card-header py-3"><h6 class="m-0 font-weight-bold text-dark">Pratinjau Tampilan Publik</h6></div>
                    <div class="card-body">
